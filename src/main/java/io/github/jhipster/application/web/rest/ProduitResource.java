...
public class ProduitResource {
     ...
     */
    @GetMapping("/produits")
    public ResponseEntity<List<ProduitDTO>> getAllProduits(ProduitCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
