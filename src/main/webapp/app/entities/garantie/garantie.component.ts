...
export class GarantieComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.garantieService
      ...
      .subscribe(
        (res: HttpResponse<IGarantie[]>) => this.paginateGaranties(res.body, res.headers),
  ...
  protected paginateGaranties(data: IGarantie[], headers: HttpHeaders) {
