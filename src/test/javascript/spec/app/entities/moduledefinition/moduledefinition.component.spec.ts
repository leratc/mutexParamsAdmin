...
import { ModuledefinitionComponent } from 'app/entities/moduledefinition/moduledefinition.component';
...
describe('Component Tests', () => {
  describe('Moduledefinition Management Component', () => {
    let comp: ModuledefinitionComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ModuledefinitionComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.moduledefinitions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
