...
import { PrestationComponent } from 'app/entities/prestation/prestation.component';
...
describe('Component Tests', () => {
  describe('Prestation Management Component', () => {
    let comp: PrestationComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PrestationComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.prestations[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
